  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-sand">
        {/* Hero */}
        <div className="bg-pine pt-36 pb-20 px-6 text-center">
          ...
          <p className="text-cream/55 text-lg mt-4 max-w-xl mx-auto leading-relaxed">
            Najciekawsze miejsca, szlaki i atrakcje w sercu Polesia Lubelskiego
          </p>
          <Link
            href="/"
            className="inline-flex items-center gap-2 mt-8 text-cream/50 hover:text-cream text-sm transition-colors duration-200"
          >
